...
3. Settings → Audira Affiliate → Products: paste each product's Amazon link (full link or amzn.to
   short link), its name, highlights, score and optional image. Defaults live in inc/catalog.php.
